...
export default function Tasks() {
  ...
  const { setTaskId, setDeleteTaskDialog } = useTasksStore();
  ...
  return (
    <>
      <div className='flex flex-col md:flex-row gap-4  md:px-36 py-12'>
        {statuses.map((status) => (
          <div key={status.key} className='flex-1 min-w-[250px]'>
            ...
            <div className='min-h-[200px]'>
              ...
              <div className='flex justify-start mt-2.5 mx-2.5'>
                <NewTaskDialog />
              </div>
            </div>
          </div>
